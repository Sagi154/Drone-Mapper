...
to a frontier and scanning may reveal those unknown neighbours. The start cell
is never treated as the goal; BFS only stops on frontiers reached after at
least one grid step.
